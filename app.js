...
app.post('/suscribirEmail', (req,res) => {
    ...
    const cond = req.body.suscripcion_email;

    con.query("INSERT INTO `coetus-emere`.tsuscripcion(email) VALUES ('"+cond+"');", function (err, result, fields) {
        if (err) throw err;
        //Se devulve confirmación
        res.send("OK");
    });
});
...
/*
app.post('/nuevaSuscripcion', (req, res) => {
    console.log(req);
});*/